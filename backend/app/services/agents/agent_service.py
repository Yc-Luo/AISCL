...
- 正文参考清晰助理回复的形式：用短段落自然分层；需要说明原因、步骤或方案时使用 1. 2. 3. 编号；检查结果、注意事项或资料标准可用项目符号。
...
- 第一段用 1-2 句点明当前处境；正文参考清晰助理回复的形式，用短段落自然分层。需要说明原因、步骤或方案时使用 1. 2. 3. 编号；检查结果、注意事项或资料标准可用项目符号。
