...
class Settings(BaseSettings):
    ...
    BACKGROUND_DASHBOARD_SNAPSHOTS_ENABLED: bool = False
    BACKGROUND_DASHBOARD_INITIAL_DELAY_SECONDS: int = 300
    BACKGROUND_DASHBOARD_INTERVAL_SECONDS: int = 1800
    ...
    MAX_TASK_ARTIFACT_SIZE: int = 52428800  # 50MB
